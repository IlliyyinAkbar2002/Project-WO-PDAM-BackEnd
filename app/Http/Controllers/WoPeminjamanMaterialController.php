...
class WoPeminjamanMaterialController extends Controller
{
    ...
    public function pinjam(Request $request, $workorder_id)
    {
        ...
        try {
            $peminjaman = $this->service->pinjam($workorder, (int) Auth::id(), $data);
    ...
    public function kembalikan(Request $request, $id)
    {
        ...
        try {
            $updated = $this->service->submitReturn($pinjaman, (int) Auth::id(), $data);
    ...
    public function verify(Request $request, $id)
    {
        ...
        try {
            $updated = $this->service->verify($pinjaman, (int) Auth::id(), $data);
